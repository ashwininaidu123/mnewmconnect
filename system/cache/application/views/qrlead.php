    ...
    <body>
        <div id="jqt">
            ...
            <div id="deal" class="selectable">
                ...
                <div>
					<form name="qrlead" method="POST" action="q/postdeal" class="form">
					<ul class="rounded">
						<li>Deal Title:<? if(!empty($deal_info)){ echo $deal_info->dealtitle;} ?></li>
						<li>Deal value:<? if(!empty($deal_info)){ echo $deal_info->dealvalue;} ?></li>
						<li>Description:<? if(!empty($deal_info)){ echo $deal_info->description;} ?></li>
						<li>Address:<? if(!empty($deal_info)){ echo $deal_info->address;} ?></li>
						<li>Phone:<? if(!empty($deal_info)){ echo $deal_info->phone;} ?></li>
						<li><input type="text" name="number" placeholder="Enter Your Mobile No." value=""/></li>
						<li><input type="text" name="email" placeholder="Enter Your Email" value=""/></li>
					</ul>
					<input type="hidden" name="submit" value="submit"/>
					<input type="hidden" name="bid" value="<?=$bid?>"/>
					<input type="hidden" name="gid" value="<?=$gid?>"/>
					<input type="hidden" name="scanid" value="<?=$scanid?>"/>
					<a style="margin:0 10px;color:rgba(0,0,0,.9)" href="#" class="submit whiteButton">Get Deal</a>
					</form>
                </div>
            </div>
        </div>
