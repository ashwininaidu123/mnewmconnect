$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[4].innerHTML = '<div class="text-center"><a class="edit btn btn-primary" href="">Save</a> <a class="delete btn btn-danger" href=""><i class="fa fa-times-circle"></i> Remove</a></div>';
        }
