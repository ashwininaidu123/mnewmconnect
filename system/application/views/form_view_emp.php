													...
													if(!empty($form['gpEmp'])){
														...
														?>
														 <tr>
															 ...
															 <td><input type="text" name="starttime" id="starttime" value="<?=$form['gpEmp']['starttime']?>" class="timepicker form-control" style="width:60px;" /></td>
															 <td><input type="text" name="endtime" id="endtime" value="<?=$form['gpEmp']['endtime']?>"  class="timepicker form-control" style="width:60px;" /></td>
