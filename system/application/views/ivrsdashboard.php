										...
										<div class="col-md-12">
										  <div class="row m-b-10">
                                           <div class="withScroll" data-height="320">
                                            ...
                                            <a href="dashboard/weekpopup/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded magnific" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div>
                                         </div>
                                       </div>
										...
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="320">
											<div class="thumbnail">
                                             ...
                                             <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbytime/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded magnific" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div>
                                          </div>
                                       </div>
									  ...
									  <div class="row">
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="320">
                                             ...
                                             <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbyweek/ivrs"  class="btn-danger btn btn-default btn-icon btn-rounded magnific" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div> 
                                          </div>
                                       </div>
