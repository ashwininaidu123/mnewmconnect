...
<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4><?php echo $this->lang->line('level_leadsreport');?></h4>
			</div>
					...
					<tr>
						...
						<td>
							<?php 
							  ...
							  echo form_dropdown('groupname[]',$this->leadsmodel->getGroups(),'',$js);
							  ?>
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php 
								...
								echo form_dropdown('empname[]',$this->leadsmodel->employee_list(),'',$js1);
							?>
						</td>
					</tr>
				</TABLE>
