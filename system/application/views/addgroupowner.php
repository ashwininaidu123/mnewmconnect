...
<script>
	...
	$(function() {
 	...
 	<div id="box">
		<h3><?php if(isset($geditlist)){ echo $this->lang->line('level_Edit_Group'); $action="Employee/edit/".$geditlist[0]['eid'];}else{ echo $this->lang->line('level_Add_Employee'); $action='';}?></h3>
			<?php
			$attributes = array('id' =>'forms','name'=>'forms','class'=>'form');		
			...
			<fieldset id="accdetail" style="display:none;">
				...
				<table>
					...
					<tr>
						<th><label for="cpassword"><?php echo $this->lang->line('level_resetpassword');?>: </label></th>
...
<table>	<tr>
					...
					<?php if(isset($geditlist)){ echo form_submit('UpdateEmployee', 'UpdateEmployee');}else{ 
						
						$jss='id="AddEmployee"';
						 echo form_submit('AddEmployee', 'AddEmployee',$jss);}
