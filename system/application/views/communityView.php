...
<form id="form" name="form" method="POST" action="community/register" autocomplete="off">
<div class="width50">
...
<? }?>
	<table width="100%">
		<tr>
			<th><label for="login_businessname">Community Name : </label></th>
		...
		<tr>
			...
			<td>					
				<?php
					...
					echo form_dropdown("language",$this->com_sysconfmodel->get_languages(),set_value('language'),$js);
				?>
			</td>
			<td></td>
		</tr>
