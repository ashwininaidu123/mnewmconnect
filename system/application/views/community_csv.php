...
<div id="box">
<h3><?php echo $this->lang->line('level_community');?></h3>
		<?php
		...
		<fieldset id="priseries">
				<legend><?php echo $this->lang->line('level_community');?></legend>
				<TABLE>
					<!--<tr>
					...
					<tr>
						...
						<td><input type="text" name="endtimes" id="endtimes" class="datepicker" value="<?php //echo date('Y-m-d');?>"/></td>
						<td></td>
					</tr>-->
					<tr>
						...
						<td><!--<input type="text" name="groupname" id="groupname" />-->
							<?php 
								$js = 'id="community" multiple';
							  echo form_dropdown('community[]',$this->systemmodel->get_communities(),'',$js);
							  ?>
						</td>
						<td></td>
					</tr>
