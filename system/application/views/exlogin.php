...
<form id="form" name="login" method="POST" action="<?=site_url('Executive/index/')?>" autocomplete="off">
<div class="login">
<div class="logintitle"><span class="loginkey"><img src="images/loginkey.png" width="39" height="54" ></span> <span>Executive Panel Login</span></div>
...
<table>
	...
	<tr><th><label for="validator">Captcha : </label></th>
	<td><input type="text" name="validator" class="validate[required,ajax[ajaxCaptchaCall]]" id="validator" style="width:100px;float:left;" />
