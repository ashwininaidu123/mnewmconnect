...
Class Groupmodel extends Model
{
	...
	function create_group(){
		...
		$arr=array_keys($_POST);
			...
			,"oneditaction","onhangup","replyattmsg","leadaction","oncallaction","supportaction","supportgrp","voicemessage"."landingregion","replytocust_missed","replytocust_attended","replytocust_repcal","replytocust_voice","replytocust_voitext"))){
