...
<td valign="top" height="150">
    ...
    <td colspan="2" height="100" valign="top">
		<table cellspacing="0" cellpadding="0" border="0" style="position:absolute; padding:10px 0px 20px 20px; ">
		<tr>
			<td>
		...
		<table cellspacing="0" cellpadding="0" border="0" align="center" style="margin-top:40px;margin-bottom:20px;">
			...
			<tr>
				<td> 
				<span class="title_chat">Mcube ${page:chat.title}</span> 
			    </td>
			</tr>
			</table>
...
${if:agent}
				<td class="text" nowrap align="right">
					${if:historyParams}
						<span style='font-size:10px;'>${msg:chat.window.chatting_with}</span>
					...
					${else:historyParams}
						<span style='font-size:10px;'>${msg:chat.window.chatting_with}</span> <b>${page:ct.user.name}</b>
					${endif:historyParams}
				</td>
${endif:agent}
${if:user}
	${if:canChangeName}
				<td class="text" nowrap align="right">
					<div id="changename1" style="display:${page:displ1};">
						...
						<td><input id="uname" type="text" size="12" value="${page:ct.user.name}" class="username1"></td>
...
<tr>
					<td height="30" align="right" valign="top" style="padding:5px" colspan="4">
						<div id="engineinfo" style="display:none;">
						</div>
						<div id="typingdiv" style="display:none;">
							${if:agent} ${page:ct.user.name}${msg:typing.user} ${else:agent} ${msg:typing.remote} ${endif:agent}	
						</div>
					</td>
				</tr>
		<tr>
...
<tr><td><table cellspacing="0" cellpadding="0" border="0" bgcolor="#000">
...
${if:canpost}
			...
			<tr>
			<td><span class="cht_button"><a href="javascript:void(0)" onclick="return false;" id="sndmessagelnk">${msg:chat.window.send_message_short,send_shortcut}</a></span></td>
			</tr>
			</table>
${endif:canpost}
		</td>
