...
<th>
	<?php echo getlocal("page.analysis.search.company") ?>
</th>
<th>
	<?php echo getlocal("page.analysis.search.phone") ?>
</th>
<th>
	<?php echo getlocal("page.analysis.search.email") ?>
</th>
<th>
...
if( $page['pagination.items'] ) {
	...
	<tr>
		...
		<td>
        	<?php echo $chatthread['company'] ?>
		</td>
		<td>
        	<?php echo $chatthread['phone'] ?>
		</td>
		<td>
        	<?php echo $chatthread['email'] ?>
		</td>
		<td>
