...
<tr>
	<th class="first">
	<?php echo getlocal("pending.table.head.name") ?>
    <a href="javascript://" onclick="window.open('<?php echo $webimroot ?>/operator/user_details.php', 'webim', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1')" style="font-size:9px;color:#002A50;text-decoration:none;">(Full Details)</a>
	</th>
